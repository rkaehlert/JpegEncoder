...
public class TesterEncoderHuffmanMaxLength {
	...
	public static void main(String[] args){
		...
		Tree maxLengthOptimizedTree = ConverterHuffmanTreeLengthLimited.convert(encoder.getTree(), 6);

		while(maxLengthOptimizedTree.getHeight() > 6){
			System.out.println("Hoehe=" + maxLengthOptimizedTree.getHeight());
			maxLengthOptimizedTree = ConverterHuffmanTreeLengthLimited.convert(maxLengthOptimizedTree, 6);
